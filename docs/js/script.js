const stateLgas = {
  ...
  "Imo": [
    ...
    "Oguta", "Ohaji/Egbema", "Okigwe", "Onuimo", "Orlu", "Orsu", "Oru East",
  ...
  "Oyo": [
    ...
    "Ibarapa North", "Ido", "Irepo", "Iseyin", "Itesiwaju", "Iwajowa", "Kajola", "Lagelu", "Ogbomoso North",
    "Ogbomoso South", "Ogo Oluwa", "Olorunsogo", "Oluyole", "Ona Ara", "Orelope", "Ori Ire", "Oyo East",
...
stateSelector.addEventListener("change", () => {
  ...
  if (selectedState && stateLgas[selectedState]) {
    stateLgas[selectedState].forEach(lga => {
      ...
      option.value = option.textContent = lga;
      lgaSelector.appendChild(option);
    });
    lgaSelector.disabled = false;
  } else {
    lgaSelector.disabled = true;
  }
});
